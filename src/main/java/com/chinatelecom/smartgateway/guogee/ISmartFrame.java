...
public class ISmartFrame
{
	...
	public boolean CheckError()
	{
		if ( !CheckAA55())
		{
			Util.UtilPrintln("AA 55 check error");
			return false;
		}
		else if (frameLength - dataLength != 46)
		{
			Util.UtilPrintln("frameLength dataLength check error");
			return false;
		}
		else if (!CheckCRC())
		{
			Util.UtilPrintln("CRC check error");
			return false;
		}
		return true;
	}
	...
	public boolean CheckAA55()
	{
		...
		{
			Util.UtilPrintln(Integer.toHexString(hedaH));
			Util.UtilPrintln(Integer.toHexString(hedaL));
			return false;
		}
		return true;
	}
